        ...
        try {
            ...
            $response = $client->request('POST', env('MAMOPAY_URL') . '/links', [
                'json' => [
                    ...
                    'capacity' => 1,
                    'active' => true,
                    'return_url' => 'http://ec2-35-72-14-243.ap-northeast-1.compute.amazonaws.com/payment-success',
                    'failure_return_url' => 'http://ec2-35-72-14-243.ap-northeast-1.compute.amazonaws.com/payment-failed',
        ...
        try {
            ...
            $response = $client->request('POST', env('MAMOPAY_URL') . '/links', [
                'json' => [
                    ...
                    'capacity' => 1,
                    'active' => true,
                    'return_url' => 'http://ec2-35-72-14-243.ap-northeast-1.compute.amazonaws.com/featured-payment-success',
                    'failure_return_url' => 'http://ec2-35-72-14-243.ap-northeast-1.compute.amazonaws.com/featured-payment-failed',
                    'processing_fee_percentage' => 0,
                    'amount' => 100,
                    'amount_currency' => 'AED',
                    'link_type' => 'standalone',
